      ...
      create table default_gold.report_skipping_sessions
    ...
    location 'hdfs://namenode:9000/user/gold/report_skipping_sessions'
...
session_stats as (
    ...
    join default_silver.dim_sessions s on n.session_id = s.session_id
    join default_silver.dim_users u on n.user_id = u.user_id
)
