      ...
      create table default_gold.report_weekday_avg_listening_time
    ...
    location 'hdfs://namenode:9000/user/gold/report_weekday_avg_listening_time'
...
with listen_times as (
    ...
    join default_silver.dim_time t on f.timestamp_ms = t.timestamp_ms
)
