      ...
      create table default_gold.report_free_vs_paid_users
    ...
    location 'hdfs://namenode:9000/user/gold/report_free_vs_paid_users'
...
with user_level_stats as (
    ...
    join default_silver.dim_users u on f.user_id = u.user_id
